...
def banner_enc():
    banner = ("\n\n\n  ______                             _    \n\x1b[1;93m |  ____|                           | |   \n | |__   _ __   ___ _ __ _   _ _ __ | |_  \n \x1b[1;95m|  __| | '_ \\ / __| '__| | | | '_ \\| __| \n | |____| | | | (__| |  | |_| | |_) | |_  \n\x1b[1;96m |______|_| |_|\\___|_|   \\__, | .__/ \\__| \n                 | |      __/ | |         \n   __ _ _ __   __| |     |___/|_|         \n  \x1b[1;96m/ _` | '_ \\ / _` |                      \n | (_| | | | | (_| |                      \n  \x1b[1;93m\\__,_|_| |_|\\__,_|               _      \n     | |                          | |     \n   __| | ___  ___ _ __ _   _ _ __ | |_    \n  / _` |/ _ \\/ __| '__| | | | '_ \\| __|   \n\x1b[1;93m | (_| |  __/ (__| |  | |_| | |_) | |_    \n  \x1b[1;96m\\__,_|\\___|\\___|_|   \\__, | .__/ \\__|   \n                        __/ | |           \n __          _______ __|___/|_|   _       \n \x1b[1;93m\\ \\        / /_   _|__   __| |  | |      \n  \\ \\  /\\  / /  | |    | |  | |__| |      \n   \\ \\/  \\/ /   | |    | |  |  __  |      \n   \x1b[1;95m \\  /\\  /   _| |_   | |  | |  | |      \n  _  \\/_ \\/   |_____| _|_|__|_|__|_|      \n \x1b[1;93m| |  | |   /\\   |  \\/  |_   _|_   _|     \n | |__| |  /  \\  | \\  / | | |   | |       \n\x1b[1;96m |  __  | / /\\ \\ | |\\/| | | |   | |       \n | |  | |/ ____ \\| |  | |_| |_ _| |_      \n \x1b[1;95m|_|  |_/_/    \\_\\_|  |_|_____|_____|     \n                                          \n                                          \n    \n").format(m)
    running(banner)
...
def menu():
    ...
    if fuck == '1' or fuck == '01':
        ...
        try:
            sp.check_output([
             'am', 'start',
             'https://api.whatsapp.com/send?phone=+923155912839&text=Report : ' + chat + ''])
        except:
...
def menu_enc():
    ...
    if inp == '1' or inp == '01':
        ...
        run('Incorrect Memasukkan Pilihan!!')
        time.sleep(2)
        menu_enc()
...
def Dua():
    ...
    ff = f + 'c'
    open(ff, 'w').write('#Programed By Hamii\n#Encrypter Tool\nimport base64\nexec(base64.b32decode("' + en + '"))')
    nm = ('').join(f.split('.')[:1]) + '-enc.py'
    os.rename(ff, nm)
    run('Encrypting script %s ' % nm)
